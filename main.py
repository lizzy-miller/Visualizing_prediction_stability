...
num_params_simple_training = logreg.coef_.size + logreg.intercept_.size
print(f"Number of Training Data: {len(sampled_df)}")
print(f"Number of Test Data: {len(test_data)}")
print(f"Number of parameters in simple logistic regression model: {num_params_simple_training}")
